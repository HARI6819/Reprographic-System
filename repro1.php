	...
	$message = '
		...
		<table border="1" width="100%" cellpadding="5" cellspacing="5">
			...
			<tr>
				...
				<td width="70%">' . $_POST["layout"] . '</td>
			</tr>
			<tr>
				<td width="30%">Payment</td>
				<td width="70%">' . $_POST["paymentdone"] . '</td>
			</tr>
			<tr>
				...
				<form method="post" enctype="multipart/form-data" id="paymentForm">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label>Layout</label>
								<select name="layout" id="layout" class="form-control required-field" required>
							...
							<div class="form-group" style="display: none;">
								<input type="text" name="paymentdone" id="paymentdone" class="form-control" required readonly />
							</div>
						</div>
					</div>
...
<script>
    ...
    $('body').on('click', '.buy_now', function (e) {
		...
		document.getElementById('paymentdone').value = totalAmount;
